...
function UpdateProduct(product) {
    return tslib_es6_awaiter(this, void 0, void 0, function* () {
        try {
            let response = yield fetch(`${appconfig_urlApi}/products/${product.id}`, {
                method: 'PUT',
                body: JSON.stringify(product),
                headers: {
                    'Content-Type': 'application/json'
...
;// CONCATENATED MODULE: ./src/ts/admin/updateProduct.ts
...
function SetCategorySelected() {
    return tslib_es6_awaiter(this, void 0, void 0, function* () {
        let product = yield GetProduct($('#btnUpdateProduct').attr('data-id'));
...
function UpdateClickHandler() {
    $('#btnUpdateProduct').on('click', function () {
        ...
        UpdateProduct(product).then(ok => {
            if (ok) {
                sweetalert2_all_default().fire("Thông báo", "Cập nhật thành công", "success");
            }
            else {
                sweetalert2_all_default().fire("Thông báo", "Cập nhật thất bại", "error");
            }
        });
    });
}

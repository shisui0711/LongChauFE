...
function DeleteCategory(id) {
    return tslib_es6_awaiter(this, void 0, void 0, function* () {
        try {
            let response = yield fetch(`${appconfig_urlApi}/categories/${id}`, {
                method: 'DELETE'
            });
            if (response.ok)
                return true;
...
;// CONCATENATED MODULE: ./src/ts/admin/viewCategory.ts
...
function SearchCategoryHandler() {
    return tslib_es6_awaiter(this, void 0, void 0, function* () {
        GetCategories().then((categories) => {
            let listCategory = new src/* List */.B8(categories);
            let categoryName = $('#txtSearchCategoryName').val();
            if (categoryName !== '') {
        ...
        categories.forEach((category) => {
            ...
            const row = `
                    <tr>
                        ...
                        <td class="align-middle">${(_a = category.iconUrl) !== null && _a !== void 0 ? _a : ""}</td>
                        <td class="align-middle">${(_b = category.description) !== null && _b !== void 0 ? _b : ""}</td>
                    </tr>
                `;
...
function DirectAddHandler() {
    $("#btnAdd").on("click", function () {
        RenderViewMain("/admin/page/addCategory.html", undefined, "/dist/js/addCategory.bundle.js");
    });
}

...
;// CONCATENATED MODULE: ./src/viewModels/ProductVM.ts
class Product {
}
...
function AddProduct(product) {
    return tslib_es6_awaiter(this, void 0, void 0, function* () {
        try {
            yield fetch(`${appconfig_urlApi}/products`, {
                method: 'POST',
...
function DeleteProduct(id) {
    return __awaiter(this, void 0, void 0, function* () {
        try {
            let response = yield fetch(`${urlApi}/products/${id}`, {
                method: 'DELETE'
            });
            if (response.ok)
                return true;
...
function GetProducts() {
    return __awaiter(this, void 0, void 0, function* () {
        try {
            let response = yield fetch(`${urlApi}/products`);
            return response.json();
        }
        catch (error) {
            console.log(error);
...
function AddProductHandler() {
    $('#btnAddProduct').on('click', () => {
        ...
        product.salesUnitPrice = $('#txtProductSalePrice').val();
        product.importUnitPrice = $('#txtProductImportPrice').val();
        product.discountPercent = $('#txtProductDiscount').val();
        product.unit = $('#txtProductUnit').val();
        product.unitExtend = $('#txtProductUnitExtend').val();
        product.giftContent = $('#txtProductGiftContent').val();
        product.categoryName = $('#txtCategoryName').val();
        if (AddProduct(product)) {
            sweetalert2_all_default().fire("Thông báo", "Thêm sản phẩm thành công", "success");
        }
        else {
            sweetalert2_all_default().fire("Thông báo", "Thêm sản phẩm thất bại", "error");
        }
    });
}

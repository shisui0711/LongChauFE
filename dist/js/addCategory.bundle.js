...
function AddCategory(category) {
    return tslib_es6_awaiter(this, void 0, void 0, function* () {
        try {
            yield fetch(`${appconfig_urlApi}/categories`, {
                method: 'POST',
...
function GetCategories() {
    return __awaiter(this, void 0, void 0, function* () {
        try {
            let response = yield fetch(`${urlApi}/categories`);
            return response.json();
        }
        catch (error) {
            console.log(error);
...
;// CONCATENATED MODULE: ./src/viewModels/CategoryVM.ts
class Category {
}
...
;// CONCATENATED MODULE: ./src/ts/admin/addCategory.ts
...
function AddCategoryHandler() {
    $('#btnAdd').on('click', () => {
        ...
        if (AddCategory(category)) {
            sweetalert2_all_default().fire("Thông báo", "Thêm danh mục thành công", "success");
        }
        else {
            sweetalert2_all_default().fire("Thông báo", "Thêm danh mục thất bại", "error");
        }
    });
}
